...
class Account extends $pb.GeneratedMessage {
  factory Account({
    ...
    if (scannedToId != null) {
      $result.scannedToId = scannedToId;
    }
    return $result;
  }
  Account._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(5, _omitFieldNames ? '' : 'shieldedAddress')
    ..aOS(6, _omitFieldNames ? '' : 'publicKey')
    ..aOS(7, _omitFieldNames ? '' : 'encryptedSecretKey')
    ..aOS(9, _omitFieldNames ? '' : 'walletId')
    ..aOS(10, _omitFieldNames ? '' : 'scannedToId')
  ...
  @$pb.TagNumber(5)
  $core.String get shieldedAddress => $_getSZ(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $core.bool hasShieldedAddress() => $_has(4);
  @$pb.TagNumber(5)
  void clearShieldedAddress() => clearField(5);
  ...
  @$pb.TagNumber(7)
  $core.String get encryptedSecretKey => $_getSZ(6);
  @$pb.TagNumber(7)
  set encryptedSecretKey($core.String v) {
    $_setString(6, v);
  }

  @$pb.TagNumber(7)
  $core.bool hasEncryptedSecretKey() => $_has(6);
  @$pb.TagNumber(7)
  void clearEncryptedSecretKey() => clearField(7);
  ...
  @$pb.TagNumber(10)
  $core.String get scannedToId => $_getSZ(8);
  @$pb.TagNumber(10)
  set scannedToId($core.String v) {
    $_setString(8, v);
  }

  @$pb.TagNumber(10)
  $core.bool hasScannedToId() => $_has(8);
  @$pb.TagNumber(10)
  void clearScannedToId() => clearField(10);
}
