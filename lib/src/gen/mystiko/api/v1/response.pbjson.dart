...
const StatusCode$json = {
  ...
  '2': [
    ...
    {'1': 'STATUS_CODE_SCANNER_ERROR', '2': 16},
    {'1': 'STATUS_CODE_GET_MYSTIKO_GUARD_ERROR', '2': 17},
    {'1': 'STATUS_CODE_DESERIALIZE_MESSAGE_ERROR', '2': 18},
  ],
};
...
final $typed_data.Uint8List statusCodeDescriptor = $convert.base64Decode(
    ...
    'U1lOQ0hST05JWkVSX0VSUk9SEA8SHQoZU1RBVFVTX0NPREVfU0NBTk5FUl9FUlJPUhAQEicKI1'
    'NUQVRVU19DT0RFX0dFVF9NWVNUSUtPX0dVQVJEX0VSUk9SEBESKQolU1RBVFVTX0NPREVfREVT'
    'RVJJQUxJWkVfTUVTU0FHRV9FUlJPUhAS');
